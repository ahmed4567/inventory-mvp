...
export default function EditProductPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  <>
    <input type="hidden" name="costPrice"    value={Number(product.costPrice)} />
    <input type="hidden" name="sellingPrice" value={Number(product.sellingPrice)} />
    <div className="grid grid-cols-2 gap-4">
      <div>
        <label className="block text-sm font-medium text-gray-500 mb-1">Cost Price</label>
        <p className="text-gray-400 text-sm bg-gray-50 rounded-lg px-3 py-2">
          🔒 Superuser only
        </p>
      </div>
      <div>
